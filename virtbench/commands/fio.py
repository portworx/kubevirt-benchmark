...
@click.command('fio')
@click.option('--action', '-a', default='run-all',
...
@click.option('--fio-directory', default='/scratch', help='Directory inside the VM to run FIO against')
...
def fio(ctx, **kwargs):
    ...
    cmd.extend(['--fio-directory', kwargs['fio_directory']])
